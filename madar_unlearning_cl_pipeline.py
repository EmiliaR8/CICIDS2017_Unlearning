    ...
    for t, task in enumerate(tasks):
        ...
        if t > 0 and len(mal_idx_train) > 0:
            ...
            if POISON_TEST_DATA and len(mal_idx_test) > 0:
                ...
                # tier 1 = C1-correct candidates (ranked most-uncertain-under-C1
                # first, same ranking scheme as train-side), tier 2 = C1-incorrect
                # candidates padded in (same ranking) once tier 1 runs out, up to
